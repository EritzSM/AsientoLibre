...
-- Existing installations may have created these foreign keys without cascade.
ALTER TABLE public.route_ratings DROP CONSTRAINT IF EXISTS route_ratings_route_id_fkey;
ALTER TABLE public.route_ratings DROP CONSTRAINT IF EXISTS route_ratings_reviewer_id_fkey;
ALTER TABLE public.route_ratings DROP CONSTRAINT IF EXISTS route_ratings_rated_id_fkey;
ALTER TABLE public.route_ratings ADD CONSTRAINT route_ratings_route_id_fkey FOREIGN KEY (route_id) REFERENCES public.routes(id) ON DELETE CASCADE;
ALTER TABLE public.route_ratings ADD CONSTRAINT route_ratings_reviewer_id_fkey FOREIGN KEY (reviewer_id) REFERENCES public.profiles(id) ON DELETE CASCADE;
ALTER TABLE public.route_ratings ADD CONSTRAINT route_ratings_rated_id_fkey FOREIGN KEY (rated_id) REFERENCES public.profiles(id) ON DELETE CASCADE;
